...
class SimulationDataCollector:
    def __init__(
        ...
        q_values_file_path_hider: str = "q_values_hider.json",
        q_values_file_path_seeker: str = "q_values_seeker.json",
    ) -> None:
        ...
        self.log = get_logger("DataCollector")
    ...
    def save_data(self) -> None:
        ...
        if self.data_file_path:
            self.log.info(f"Saving data to {self.data_file_path}.")
    ...
    def save_q_values(self, board: Board) -> None:
        ...
        self.log.info(f"Saving Q-values to {self.q_values_file_path_hider}.")
        with open(self.q_values_file_path_hider, "w") as file:
            json.dump(hider_q_values, file)

        self.log.info(f"Saving Q-values to {self.q_values_file_path_seeker}.")
